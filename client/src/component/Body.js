...
const Body = () => {
  ...
  if (onlineStatus == false)
    return (
      <h1>look's like you're offline pls check your internet connection</h1>
    );
    ...
    <div className="body  pl-12">
      <div className="filter flex  ">
        <div className="search p-4 m-4">
          ...
          />
          <button
            className="px-5  py-1 m-4 bg-cyan-300 rounded-xl"
            onClick={() => {
        ...
        <div className="px-5  py-1 m-4 flex items-center ">
          ...
          <input
            className=" px-3 border border-solid border-black cursor-pointer hover: text-xl "
            value={loggedInUser}
